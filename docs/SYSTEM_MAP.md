...
- Full-workspace cloud Push/Pull contract: `src/core/workspace-cloud-sync.js`; it coordinates `fibo_data`, `trend_tracker_state` and permanent-ID market bindings for all three page controllers. Wave startup is local-only; cloud Pull is explicit.
